...
class Courses(models.Model):
    id = models.AutoField(primary_key=True)  # Primary key auto-incremented
    course_name = models.CharField(max_length=255)  # Course name with a max length of 255 characters
    created_at = models.DateTimeField(auto_now_add=True)  # Timestamp for creation
    updated_at = models.DateTimeField(auto_now=True)  # Timestamp for last update
    objects = models.Manager()  # Default manager

    def __str__(self):
        return self.course_name  # Returns course name for string representation
